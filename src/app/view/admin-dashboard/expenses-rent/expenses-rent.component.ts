...
@Component({
  selector: 'app-expenses-rent',
  imports: [RouterLink, CommonModule],
  templateUrl: './expenses-rent.component.html',
  styleUrl: './expenses-rent.component.scss'
})
export class ExpensesRentComponent implements OnInit {
